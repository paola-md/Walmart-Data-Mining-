# Caso Walmart - Comprensión del Negocio
...
A manera de ejemplo, se puede pensar por ejemplo que existen diferencias entre los clientes que hacen una visita rápida a un establecimiento para , que aquellos que surten sus alacenas para consumo de víveres en la de semana
...
Como criterio para determinar el cumplimiento del objetivo del proyecto, se estableció que el modelo propuesto tenga un mejor desempeño que los modelo que emplean datos sin realizar ningún pre-procesamiento de la información. Ello significa que la metodología del proyecto sea capaz de superar a [Pendiente: establecer cuáles serían estos modelos; i.e. se refiere a resultados que ya están en Kaggle? se refiere a que nosotros impongamos un baseline, digamos una regresión logística en problema de multi-clasificación?], donde la métrica asociada sea [Pendiente: establecer una métrica adecuada en función de los modelos a superar].
